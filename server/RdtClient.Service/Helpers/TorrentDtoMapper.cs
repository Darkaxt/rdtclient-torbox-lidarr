...
public static class TorrentDtoMapper
{
                                    ...
                                    Boolean includeFileOrMagnet)
    {
        ...
        return new()
        {
            ...
            RdAvailability = torrent.RdAvailability,
            RdPeers = torrent.RdPeers,
            RdTracker = torrent.RdTracker,
            RdTrackerMessage = torrent.RdTrackerMessage,
            RdHealthSource = torrent.RdHealthSource,
            RdHealthUpdatedAt = torrent.RdHealthUpdatedAt,
